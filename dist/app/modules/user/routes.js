...
const validdation_1 = require("./validdation");
const router = express_1.default.Router();
router.post('/create-admin', (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN), (0, validateRequest_1.default)(validdation_1.UserValidations.createAdmin), controller_1.UserController.createAdmin);
...
router.patch('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.ADMIN), controller_1.UserController.updateUser);
